...
<head>
    ...
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/nunito-sans-v18-latin-200.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/nunito-sans-v18-latin-600.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/urbanist-v17-latin-600.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <?php
...
<header id="wrapper-navbar" class="fixed-top p-0">
	<nav class="navbar navbar-expand-md">
		<div class="container gap-4">
			<div class="logo-container"><a href="/" class="logo navbar-brand" aria-label="Nick Statman Homepage"></a></div>
